{ ... }:
{
  ...
  home.file = {
    ...
    # One Material 3 Theme Templates
    ".local/share/matugen/template/one-material3.json".text = ''
      {
        ...
        "themes": [
          {
            "name": "One Material 3 Dark",
            "appearance": "dark",
            "style": {
              "border": "{{colors.outline_variant.dark.hex}}",
              "border.variant": "{{colors.outline.dark.hex}}",
              "border.focused": "{{colors.primary.dark.hex}}",
              "border.selected": "{{colors.primary_container.dark.hex}}",
              "border.transparent": "#00000000",
              "border.disabled": "{{colors.outline_variant.dark.hex}}",
              "elevated_surface.background": "{{colors.surface_container_low.dark.hex}}",
              ...
              "element.selected": "{{colors.surface_container_highest.dark.hex}}",
              "element.disabled": "{{colors.surface_container.dark.hex}}",
              "drop_target.background": "{{colors.primary.dark.hex}}80",
              "ghost_element.background": "#00000000",
              "ghost_element.hover": "{{colors.surface_container_high.dark.hex}}",
              "ghost_element.active": "{{colors.surface_container_highest.dark.hex}}",
              "ghost_element.selected": "{{colors.surface_container_highest.dark.hex}}",
              "ghost_element.disabled": "{{colors.surface_container.dark.hex}}",
              "text": "{{colors.on_surface.dark.hex}}",
              "text.muted": "{{colors.on_surface_variant.dark.hex}}",
              "text.placeholder": "{{colors.outline.dark.hex}}",
              "text.disabled": "{{colors.outline.dark.hex}}",
              "text.accent": "{{colors.primary.dark.hex}}",
              "icon": "{{colors.on_surface.dark.hex}}",
              "icon.muted": "{{colors.on_surface_variant.dark.hex}}",
              "icon.disabled": "{{colors.outline.dark.hex}}",
              "icon.placeholder": "{{colors.on_surface_variant.dark.hex}}",
              "icon.accent": "{{colors.primary.dark.hex}}",
              "status_bar.background": "{{colors.background.dark.hex}}",
              "title_bar.background": "{{colors.background.dark.hex}}",
              "title_bar.inactive_background": "{{colors.surface_container.dark.hex}}",
              "toolbar.background": "{{colors.surface.dark.hex}}",
              "tab_bar.background": "{{colors.surface_container_low.dark.hex}}",
              "tab.inactive_background": "{{colors.surface_container_low.dark.hex}}",
              "tab.active_background": "{{colors.surface.dark.hex}}",
              "search.match_background": "{{colors.primary.dark.hex}}66",
              "panel.background": "{{colors.surface_container_low.dark.hex}}",
              "panel.focused_border": null,
              "pane.focused_border": null,
              "scrollbar.thumb.background": "{{colors.outline_variant.dark.hex}}4c",
              "scrollbar.thumb.hover_background": "{{colors.surface_container_high.dark.hex}}",
              "scrollbar.thumb.border": "{{colors.surface_container_high.dark.hex}}",
              "scrollbar.track.background": "#00000000",
              "scrollbar.track.border": "{{colors.outline_variant.dark.hex}}",
              "editor.foreground": "{{colors.on_surface.dark.hex}}",
              "editor.background": "{{colors.surface.dark.hex}}",
              "editor.gutter.background": "{{colors.surface.dark.hex}}",
              "editor.subheader.background": "{{colors.surface_container_low.dark.hex}}",
              "editor.active_line.background": "{{colors.surface_container_low.dark.hex}}bf",
              "editor.highlighted_line.background": "{{colors.surface_container_low.dark.hex}}",
              "editor.line_number": "{{colors.outline.dark.hex}}",
              "editor.active_line_number": "{{colors.on_surface.dark.hex}}",
              "editor.hover_line_number": "{{colors.on_surface_variant.dark.hex}}",
              "syntax": {
                "attribute": {
          ...
          {
            "name": "One Material 3 Light",
            "appearance": "light",
            "style": {
              "border": "{{colors.outline_variant.light.hex}}",
              "border.variant": "{{colors.outline.light.hex}}",
              "border.focused": "{{colors.primary.light.hex}}",
              "border.selected": "{{colors.primary_container.light.hex}}",
              "border.transparent": "#00000000",
              "border.disabled": "{{colors.outline_variant.light.hex}}",
              "elevated_surface.background": "{{colors.surface_container_low.light.hex}}",
              ...
              "element.selected": "{{colors.surface_container_highest.light.hex}}",
              "element.disabled": "{{colors.surface_container.light.hex}}",
              "drop_target.background": "{{colors.primary.light.hex}}80",
              "ghost_element.background": "#00000000",
              "ghost_element.hover": "{{colors.surface_container_high.light.hex}}",
              "ghost_element.active": "{{colors.surface_container_highest.light.hex}}",
              "ghost_element.selected": "{{colors.surface_container_highest.light.hex}}",
              "ghost_element.disabled": "{{colors.surface_container.light.hex}}",
              "text": "{{colors.on_surface.light.hex}}",
              "text.muted": "{{colors.on_surface_variant.light.hex}}",
              "text.placeholder": "{{colors.outline.light.hex}}",
              "text.disabled": "{{colors.outline.light.hex}}",
              "text.accent": "{{colors.primary.light.hex}}",
              "icon": "{{colors.on_surface.light.hex}}",
              "icon.muted": "{{colors.on_surface_variant.light.hex}}",
              "icon.disabled": "{{colors.outline.light.hex}}",
              "icon.placeholder": "{{colors.on_surface_variant.light.hex}}",
              "icon.accent": "{{colors.primary.light.hex}}",
              "status_bar.background": "{{colors.background.light.hex}}",
              "title_bar.background": "{{colors.background.light.hex}}",
              "title_bar.inactive_background": "{{colors.surface_container.light.hex}}",
              "toolbar.background": "{{colors.surface.light.hex}}",
              "tab_bar.background": "{{colors.surface_container_low.light.hex}}",
              "tab.inactive_background": "{{colors.surface_container_low.light.hex}}",
              "tab.active_background": "{{colors.surface.light.hex}}",
              "search.match_background": "{{colors.primary.light.hex}}66",
              "panel.background": "{{colors.surface_container_low.light.hex}}",
              "panel.focused_border": null,
              "pane.focused_border": null,
              "scrollbar.thumb.background": "{{colors.outline_variant.light.hex}}4c",
              "scrollbar.thumb.hover_background": "{{colors.surface_container_high.light.hex}}",
              "scrollbar.thumb.border": "{{colors.surface_container_high.light.hex}}",
              "scrollbar.track.background": "#00000000",
              "scrollbar.track.border": "{{colors.outline_variant.light.hex}}",
              "editor.foreground": "{{colors.on_surface.light.hex}}",
              "editor.background": "{{colors.surface.light.hex}}",
              "editor.gutter.background": "{{colors.surface.light.hex}}",
              "editor.subheader.background": "{{colors.surface_container_low.light.hex}}",
              "editor.active_line.background": "{{colors.surface_container_low.light.hex}}bf",
              "editor.highlighted_line.background": "{{colors.surface_container_low.light.hex}}",
              "editor.line_number": "{{colors.outline.light.hex}}",
              "editor.active_line_number": "{{colors.on_surface.light.hex}}",
              "editor.hover_line_number": "{{colors.on_surface_variant.light.hex}}",
              "syntax": {
                "attribute": {
