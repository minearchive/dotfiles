...
QtObject {
    // Primary Colors
    readonly property color primary: "#ffb4a5"
    readonly property color primary_fixed: "#ffdad3"
    readonly property color primary_fixed_dim: "#ffb4a5"
    readonly property color on_primary: "#561e14"
    readonly property color on_primary_fixed: "#3a0a03"
    readonly property color on_primary_fixed_variant: "#733428"
    readonly property color primary_container: "#733428"
    ...
    // Tertiary Colors
    readonly property color tertiary: "#dcc48c"
    readonly property color tertiary_fixed: "#f9e0a6"
    readonly property color tertiary_fixed_dim: "#dcc48c"
    readonly property color on_tertiary: "#3d2f04"
    ...
    readonly property color on_tertiary_container: "#f9e0a6"
    ...
    readonly property color inverse_primary: "#904b3d"
    ...
    // Source Color
    readonly property color source_color: "#db462b"
